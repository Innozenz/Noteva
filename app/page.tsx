        ...
        <section className="relative overflow-hidden">
          ...
          >
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgb(79 70 229 / 0.14), transparent 65%)",
              }}
            />
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgb(236 72 153 / 0.11), transparent 65%)",
              }}
            />
          </div>
          ...
          <Spotlight className="relative overflow-hidden bg-foreground text-background">
            <div
              ...
              style={{
                ...
                background:
                  "radial-gradient(26rem 26rem at var(--spot-x, 50%) var(--spot-y, 50%), rgb(99 102 241 / 0.3), transparent 70%)",
              }}
            />
